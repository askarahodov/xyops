// OpsRocket API Layer - Satellite Install Utilities
...
class Satellite {
	...
	fetch_satellite_install(args, callback) {
		...
		// Linux/macOS: curl -s https://OPSROCKET/api/app/satellite/install?t=123456 | sudo sh
		// Windows: powershell -Command "IEX (New-Object Net.WebClient).DownloadString('https://OPSROCKET/api/app/satellite/install?t=123456&os=windows')"
